...
def scrape_dining_hall(url, hall_name):
    ...
    try:
        ...
        # JavaScript to extract menu items
        js_script = """
        function extractFoodItems() {
            let foodItems = [];
            
            // Words that indicate non-food content
            ...
            // Look for items with specific product card selectors
            ...
            // Try a more general approach if specific selectors yield nothing
            ...
            // Last resort - check for common food names
        ...
        # Try clicking tabs if no items found
        if not food_items:
        ...
        # Further filter to keep only actual food items
        filtered_items = []
